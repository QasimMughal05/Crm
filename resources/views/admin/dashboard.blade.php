...
<div class="container">
    <nav class="navbar navbar-dark bg-dark">
        ...
        <a class="navbar-brand " href="{{route('product.create')}}">ADD</a>
    </nav>
                ...
                <tbody>
                    @foreach ( $product as $products)
                        ...
                        <tr>
                            ...
                            <td class="font-weight-bold"> <a class="navbar-brand" href="{{route('product.edit',['id'=>$products->id])}}">Edit</a>
                             <a class="navbar-brand" href="{{route('product.delete',['id'=>$products->id])}}">Delete</a></td>
                            <td></td>
